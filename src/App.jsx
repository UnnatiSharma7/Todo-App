    ...
    <RequireAuth>
     ...
     <div className="container mx-auto my-10 rounded-xl p-5 font-serif text-base bg-violet-100 min-h-[70vh]">
       ...
       <div className="tasks"> 
        ...
        return <div className="task bg-transparent drop-shadow-md hover:drop-shadow-xl flex flex-row flex-wrap bg-violet-200 justify-between my-2 border hover:border-violet-600 rounded-2xl px-5 py-5">
          <div className="text basis-1/3">{item.task}</div>
          <div className="buttons order-last">
          {!item.isIndoor && <button onClick={handleFetchWeather} className="mx-1 text-white bg-violet-700 hover:bg-violet-800 rounded-2xl px-5 py-2"><TiWeatherPartlySunny /></button>}
           {/* Weather Popup */}
      {isPopupVisible && (
